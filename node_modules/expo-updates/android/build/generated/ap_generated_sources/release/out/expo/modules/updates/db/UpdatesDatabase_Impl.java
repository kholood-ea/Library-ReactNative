...
public final class UpdatesDatabase_Impl extends UpdatesDatabase {
  ...
  protected SupportSQLiteOpenHelper createOpenHelper(DatabaseConfiguration configuration) {
    final SupportSQLiteOpenHelper.Callback _openCallback = new RoomOpenHelper(configuration, new RoomOpenHelper.Delegate(1) {
      ...
      public void createAllTables(SupportSQLiteDatabase _db) {
        ...
        _db.execSQL("CREATE TABLE IF NOT EXISTS `assets` (`id` INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, `url` TEXT NOT NULL, `headers` TEXT, `type` TEXT NOT NULL, `metadata` TEXT, `download_time` INTEGER, `relative_path` TEXT, `hash` BLOB, `hash_type` INTEGER NOT NULL, `marked_for_deletion` INTEGER NOT NULL)");
        _db.execSQL("CREATE UNIQUE INDEX `index_assets_url` ON `assets` (`url`)");
        _db.execSQL("CREATE TABLE IF NOT EXISTS room_master_table (id INTEGER PRIMARY KEY,identity_hash TEXT)");
        _db.execSQL("INSERT OR REPLACE INTO room_master_table (id,identity_hash) VALUES(42, '9b658decc2da8342965b5f5978f193b1')");
      }
      ...
      protected void validateMigration(SupportSQLiteDatabase _db) {
        ...
        _columnsUpdates.put("project_identifier", new TableInfo.Column("project_identifier", "TEXT", true, 0));
        ...
        _indicesUpdates.add(new TableInfo.Index("index_updates_project_identifier_commit_time", true, Arrays.asList("project_identifier","commit_time")));
        ...
        _columnsAssets.put("url", new TableInfo.Column("url", "TEXT", true, 0));
        ...
        _indicesAssets.add(new TableInfo.Index("index_assets_url", true, Arrays.asList("url")));
    ...
    }, "9b658decc2da8342965b5f5978f193b1", "0525199e907979957a01cd4ecb7b64bb");
  ...
  protected InvalidationTracker createInvalidationTracker() {
    ...
    return new InvalidationTracker(this, _shadowTablesMap, _viewTables, "updates","updates_assets","assets");
  }
